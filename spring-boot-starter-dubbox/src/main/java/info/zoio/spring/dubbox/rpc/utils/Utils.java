package info.zoio.spring.dubbox.rpc.utils;
...
public class Utils {
	 ...
	 * @return
	 */
	public final static Result decodeException(Result relust) {
	 ...
	 * @return
	 */
	public final static Result encoderException(Result relust) {
		if (relust != null && relust.hasException()) {
			Throwable throwable = relust.getException();
